...
$(document).ready(function(){
  ...
  //------- Active Nice Select --------//
    ...
    // Search Toggle
    //$("#search_input_box").hide();  // Hide the search bar
    /*$("#search").on("click", function () { // Button to toggle hide the search bar
        $("#search_input_box").slideToggle();
        $("#search_input").focus();
    });
    /*$("#close_search").on("click", function () { // Button to close the search bar
